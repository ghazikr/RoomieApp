...
namespace FacebookLogin.Views
{
    public class FacebookProfileCsPage : ContentPage
    {
        ...
        /// </summary>
        private string ClientId = "1414237875280843";//"1570192756563503";
        ...
        public FacebookProfileCsPage()
        {
            ...
            var apiRequest =
                "https://m.facebook.com/dialog/oauth?client_id="
                + ClientId
        ...
        private async void WebViewOnNavigated(object sender, WebNavigatedEventArgs e)
        {
            ...
            if (e.Url.Contains("www.facebook.com/connect/login_success.html"))
            {
            ...
            if (accessToken != "")
            {
                ...
                var x = await DbServices.addUserIfNotExist(vm.FacebookProfile);
                await Navigation.PushAsync(new MainPage(vm.FacebookProfile));
